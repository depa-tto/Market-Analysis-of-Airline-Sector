...
# data
raw_data <- read_csv("https://raw.githubusercontent.com/depa-tto/Market-Analysis-of-Airline-Sector/refs/heads/main/Dataset/airline_satisfaction.csv")
...
fitord <- princals(as.data.frame(final_data), ndim = 3, ordinal = TRUE)
summary(fitord)
